# Getting help with epikit

Thanks for using epikit. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/epikit/issues) to make sure the 
