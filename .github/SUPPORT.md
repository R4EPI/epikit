# Getting help with msfmisc

Thanks for using msfmisc. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/msfmisc/issues) to make sure the 
