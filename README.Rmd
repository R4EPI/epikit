...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/zkamvar/epikit?branch=master&svg=true)](https://ci.appveyor.com/project/zkamvar/epikit)
...
The goal of epikit is to ...

## Installation

You can install the released version of epikit from [CRAN](https://CRAN.R-project.org) with:
